...
import com.hadoop.Mapper.CountPageViewerMaper;
...
import com.hadoop.Reduce.PageViewerReduce;
import com.hadoop.Reduce.UserViewTimeCountReduce;

public class PageViewerJob extends Configured implements Tool {

	@Override
	public int run(String[] arg0) throws Exception {
		final Job job = new Job(new Configuration(),
				PageViewerJob.class.getSimpleName());
		job.setJarByClass(PageViewerJob.class);
		FileInputFormat.setInputPaths(job, arg0[0]);
		job.setMapperClass(CountPageViewerMaper.class);
		job.setCombinerClass(IntSumReducer.class);

		job.setReducerClass(PageViewerReduce.class);
	...
	public static void main(String[] args) {
		String[] agrs = new String[] { "file:///E:/yearout",
				"file:///E:/Pageview" };
		try {
			int res = ToolRunner.run(new Configuration(), new PageViewerJob(),
					agrs);
			System.exit(res);
		} catch (Exception e) {
