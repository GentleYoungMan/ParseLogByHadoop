...
import com.hadoop.Mapper.CountTZurlMaper;
...
import com.hadoop.Reduce.TZurlReduce;
import com.hadoop.Reduce.UserViewTimeCountReduce;

public class TZurlJob extends Configured implements Tool {

	@Override
	public int run(String[] arg0) throws Exception {
		final Job job = new Job(new Configuration(),
				TZurlJob.class.getSimpleName());
		job.setJarByClass(TZurlJob.class);
		FileInputFormat.setInputPaths(job, arg0[0]);
		job.setMapperClass(CountTZurlMaper.class);
		job.setCombinerClass(IntSumReducer.class);

		job.setReducerClass(TZurlReduce.class);
	...
	public static void main(String[] args) {
		String[] agrs = new String[] { "file:///E:/yearout",
				"file:///E:/ALLTZURL" };
		try {
			int res = ToolRunner.run(new Configuration(), new TZurlJob(),
					agrs);
			System.exit(res);
		} catch (Exception e) {
